          ...
          style={
            {
              ...
              '--gradient':
                variant === 'white'
                  ...
                  : `radial-gradient(circle, #064e3b 20%, #064e3b00 35%),
                  radial-gradient(circle at 40% 40%, #059669 12%, #05966900 28%), 
                  radial-gradient(circle at 60% 60%, #047857 14%, #04785700 30%), 
                  radial-gradient(circle at 40% 60%, #065f46 12%, #065f4600 28%), repeating-conic-gradient(
                    from 236.84deg at 50% 50%,
                    #064e3b 0%,
                    #059669 calc(25% / var(--repeating-conic-gradient-times)),
                    #047857 calc(50% / var(--repeating-conic-gradient-times)),
                    #065f46 calc(75% / var(--repeating-conic-gradient-times)),
                    #064e3b calc(100% / var(--repeating-conic-gradient-times))
                    )`
